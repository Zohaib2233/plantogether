...
class CustomSnackBars {
  ...
  void showToast({required String message}){
    Fluttertoast.showToast(msg: message,fontSize: 14,backgroundColor: Colors.grey,textColor: Colors.black,toastLength: Toast.LENGTH_SHORT,);
  }

  showCustomSnack({required Color color, required String message}){
